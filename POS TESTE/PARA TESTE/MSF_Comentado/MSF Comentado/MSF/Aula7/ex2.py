...
CMag = 0.5*PAr*r*area/m #Fmagnus = C * W * V
...
for i in range(t.size-1):
    ...
    Amx = -CMag * Wz * Vy[i]  #acelaracao criada pela forca de magnus x
    Amy = CMag * Wz * Vx[i] #acelaracao criada pela forca de magnus em y
    
    Ax = -D*vAbs*Vx[i] + Amx #acelaracao em x
    Ay =  g -D*vAbs*Vy[i] + Amy #acelaracao em y
    Az =  -D*vAbs*Vz[i] #acelaracao em z
